...
function showCategoriesList() {
  ...
  for (let i = 0; i < currentCategoriesArray.length; i++) {
    ...
    if (
      ...
      htmlContentToAppend += `
           <br>  <div onclick="setCatID(${category.id})" class="list-group-item hover list-group-item-action cursor-active">
            <div class="row">
                <div class="col-3">
                ...
                <div class="col">
                    <div class="d-flex w-100 justify-content-between">
                        <h4 class="mb-1 productname">${category.name}</h4>
...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  document
    ...
    .addEventListener("click", function () {
      ...
      if (
        validNumberRegex.test(minCountValue) &&
        validNumberRegex.test(maxCountValue)
      ) {
